        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Inquilino</th>
                <th className="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Contacto</th>
                <th className="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Propiedad</th>
                <th className="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Contrato</th>
                <th className="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Saldo</th>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {tenants.map((tenant) => (
                ...
                >
                  <td className="px-2 py-2 whitespace-nowrap max-w-[180px]">
                    <div className="flex items-center gap-2">
                      <div className="flex-shrink-0 h-7 w-7 rounded-full bg-blue-100 flex items-center justify-center">
                        <User className="h-3.5 w-3.5 text-blue-600" />
                      </div>
                      <div className="text-xs font-medium text-gray-900 truncate">{tenant.name}</div>
                    </div>
                  </td>
                  ...
                  <td className="px-2 py-2 whitespace-nowrap max-w-[160px]">
                    <div className="text-xs font-medium text-gray-900 truncate">{tenant.property || '—'}</div>
                  </td>
                  <td className="px-2 py-2 whitespace-nowrap">
                    <div className="text-xs text-gray-700">{tenant.contractStart}</div>
                    <div className="text-xs text-gray-400">{tenant.contractEnd}</div>
                  </td>
                  <td className="px-2 py-2 whitespace-nowrap">
                    {(() => {
                  ...
                  <td className="px-2 py-2 whitespace-nowrap text-sm font-medium" onClick={(e) => e.stopPropagation()}>
